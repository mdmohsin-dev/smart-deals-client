const FAQ = () => {
    return (
        <div className='max-w-250 mx-auto w-11/12 mb-32 mt-24 text-black'>
            <div className='text-center lg:w-8/12 w-full mx-auto'>
                <h3 className='text-5xl font-bold'>Frequently Asked Question</h3>
            ...
            <div className='mt-10 bg-white'>
                <div className="collapse collapse-arrow bg-[#FBFAFF] text-black border border-[#d4d2d2] mt-4">
